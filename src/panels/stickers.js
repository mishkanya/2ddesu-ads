      ...
      return (
        <Div >
          ...
          {this.state.isMobilVersion?
            <Div>
              В мобильном приложениии ВКонтакте выдача стикеров не доступна, но вы можете получить их в <Link target="_new" href="https://vk.cc/atxASV">веб версии приложения</Link>
            </Div>
          :
