      ...
      return (
        <Div >
          ...
          {this.state.isMobilVersion?
            <Div>
              В мобильном приложениии ВКонтакте выдача стикеров не доступна, но вы можете получить их в <Link target="_new" href="https://vk.com/app7367088_372864591">веб версии приложения</Link>
            </Div>
          :
